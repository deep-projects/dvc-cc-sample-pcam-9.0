...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584075851.205c5240029a.212.547.v2
	new:                tensorboard/train/events.out.tfevents.1584075856.205c5240029a.profile-empty
	new:                tensorboard/train/plugins/profile/2020-03-13_05-04-16/local.trace
	new:                tensorboard/validation/events.out.tfevents.1584075916.205c5240029a.212.2390.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.2 --batch-size 128 --num-of-epochs 10 --activation-function relu --kernel-width 3 --average-kernels 64 --num-of-conv-layers 4 --kernel-increasing-factor 1.1 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0 --dropout-factor-after-maxp 0.1
