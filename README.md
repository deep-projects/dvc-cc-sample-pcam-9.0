...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584075556.db41a157d503.212.547.v2
	new:                tensorboard/train/events.out.tfevents.1584075561.db41a157d503.profile-empty
	new:                tensorboard/train/plugins/profile/2020-03-13_04-59-21/local.trace
	new:                tensorboard/validation/events.out.tfevents.1584075621.db41a157d503.212.2390.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.5 --batch-size 128 --num-of-epochs 10 --activation-function relu --kernel-width 3 --average-kernels 64 --num-of-conv-layers 4 --kernel-increasing-factor 1.1 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0 --dropout-factor-after-maxp 0.1
