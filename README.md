...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584072460.ab5b781e3ca8.213.547.v2
	new:                tensorboard/train/events.out.tfevents.1584072465.ab5b781e3ca8.profile-empty
	new:                tensorboard/train/plugins/profile/2020-03-13_04-07-45/local.trace
	new:                tensorboard/validation/events.out.tfevents.1584072526.ab5b781e3ca8.213.2390.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.1 --batch-size 128 --num-of-epochs 2 --activation-function tanh --kernel-width 3 --average-kernels 64 --num-of-conv-layers 4 --kernel-increasing-factor 1.1 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0 --dropout-factor-after-maxp 0.1
